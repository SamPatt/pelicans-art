...
- GitHub Pages and skill download/checksum verification passed. The current download is skill 1.0.15, which adds asset discovery, searchable asset metadata, and reusable preview, inspection, and packaging tools alongside chat-based creative review; earlier immutable releases remain available for reproducibility.
