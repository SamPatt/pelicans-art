...
- GitHub Pages and skill download/checksum verification passed. The current download is skill 1.0.16, which adds combined finish/check/package execution, geometry-aware camera framing, and capture marker removal alongside asset discovery and chat-based creative review; earlier immutable releases remain available for reproducibility.
