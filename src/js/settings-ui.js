(function initSettingsUi(global) {
  ...
  function renderWizard() {
    ...
    if (wizardState.step===0) {
      body.innerHTML=`<p class="ait-wizard-kicker">Choose your entrance</p><h2>What would you like to do?</h2><p class="ait-wizard-lede">Start in your agent chat to make characters and voiced videos. Use this studio to import, remix, or edit visually; an API provider is optional.</p><div class="ait-choice-grid"><a class="ait-choice" href="agent.html"><span class="ait-choice-badge">Recommended</span><strong>Create with your agent</strong><span>Write in chat, generate local voices, and get a finished video.</span></a><button class="ait-choice" data-path="remix" type="button"><strong>Remix a sample</strong><span>Open a finished skit with its actors and scenery ready to change.</span></button><button class="ait-choice" data-path="ai" type="button"><strong>Create with AI</strong><span>Connect a provider, then generate characters, scenery, and scripts.</span></button><button class="ait-choice" data-path="import" type="button"><strong>Import from the Pouch</strong><span>Bring a shared community character or skit into your studio.</span></button><button class="ait-choice" data-path="scratch" type="button"><strong>Start empty</strong><span>Draw and write manually. No account or API key needed.</span></button></div><div id="ait-wizard-message" class="ait-wizard-message"></div>`;
